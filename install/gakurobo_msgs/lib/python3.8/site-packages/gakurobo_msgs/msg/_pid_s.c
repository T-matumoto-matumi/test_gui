...
bool gakurobo_msgs__msg__pid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gakurobo_msgs.msg._pid.Pid", full_classname_dest, 26) == 0);
  }
  gakurobo_msgs__msg__Pid * ros_message = _ros_message;
  {  // kp
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * gakurobo_msgs__msg__pid__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Pid */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gakurobo_msgs.msg._pid");
  ...
  gakurobo_msgs__msg__Pid * ros_message = (gakurobo_msgs__msg__Pid *)raw_ros_message;
  {  // kp
    PyObject * field = NULL;
