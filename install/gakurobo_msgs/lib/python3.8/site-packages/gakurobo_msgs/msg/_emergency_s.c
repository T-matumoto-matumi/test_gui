...
bool gakurobo_msgs__msg__emergency__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gakurobo_msgs.msg._emergency.Emergency", full_classname_dest, 38) == 0);
  }
  gakurobo_msgs__msg__Emergency * ros_message = _ros_message;
  {  // emergency
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * gakurobo_msgs__msg__emergency__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Emergency */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("gakurobo_msgs.msg._emergency");
  ...
  gakurobo_msgs__msg__Emergency * ros_message = (gakurobo_msgs__msg__Emergency *)raw_ros_message;
  {  // emergency
    PyObject * field = NULL;
