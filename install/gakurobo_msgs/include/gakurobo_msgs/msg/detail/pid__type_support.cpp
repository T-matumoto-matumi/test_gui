...
{
  new (message_memory) gakurobo_msgs::msg::Pid(_init);
}

void Pid_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gakurobo_msgs::msg::Pid *>(message_memory);
  typed_message->~Pid();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pid_message_member_array[3] = {
  {
    ...
    offsetof(gakurobo_msgs::msg::Pid, kp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gakurobo_msgs::msg::Pid, ki),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gakurobo_msgs::msg::Pid, kd),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<gakurobo_msgs::msg::Pid>()
{
  return &::gakurobo_msgs::msg::rosidl_typesupport_introspection_cpp::Pid_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gakurobo_msgs, msg, Pid)() {
  return &::gakurobo_msgs::msg::rosidl_typesupport_introspection_cpp::Pid_message_type_support_handle;
}
